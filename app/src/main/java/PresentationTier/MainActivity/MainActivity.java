...
/*        DatabaseManager databaseManager = new DatabaseManager(this);
        ...
        wp.add(new Waypoint(false, false, "VVV", "Het Begin en het Eindpunt van deze route. U kan veel informatie opvragen bij de VVV over breda en zijn oudheid.", "51.588762", "4.776913", 0, images1));
        images1 = new ArrayList<>();
        images1.add("https://media-cdn.tripadvisor.com/media/photo-s/15/a4/74/91/buiten-kant.jpg");
        wp.add(new Waypoint(false, false, "De Bruine Pij", "Dat ene café in Breda, onder de Grote Kerk. Kom in de zomer lekker in de zon zitten op ons mooie terras aan de Grote Kerk, of zoek in de winter de gezelligheid op in ons knusse bruine café. Geniet het hele jaar door van lekkere koffie, huisgemaakte appeltaart en de mooiste speciaalbieren.Sinds 1975", "51.5874764", "4.77672994", 0, images1));
        images1 = new ArrayList<>();
        ...
        ArrayList<String> routeNames1 = routeHelper.getAllRouteNames(this);
